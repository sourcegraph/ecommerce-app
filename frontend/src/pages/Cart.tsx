...
const Cart = () => {
  ...
  const productsInCart = products.flatMap((product) => (product.inCart === true ? product : []))
    ...
    <Box as="main" bg="sand.50" minH="100vh">
      {productsInCart.length > 0 ? (
        <Box maxW="container.xl" mx="auto" px={{ base: 4, md: 8 }} py={{ base: 6, md: 10 }}>
          ...
          <Grid templateColumns={{ base: '1fr', md: '2fr 1fr' }} gap={{ base: 6, md: 12 }}>
            <GridItem>
            ...
            >
              <Box
                ...
                shadow="sm"
              >
                <Heading size="md" color="ink.900" mb={5} fontSize="xl" fontWeight="semibold">
                  Order Summary
                </Heading>

                <VStack spacing={3} mb={4} align="stretch">
                  <Box display="flex" justifyContent="space-between" alignItems="center">
                    <Text color="charcoal.700" fontSize="sm">
                      Subtotal
                    </Text>
                    <Text color="ink.900" fontWeight="medium">
                  ...
                  <Box display="flex" justifyContent="space-between" alignItems="center">
                    ...
                    <Text color="charcoal.600" fontSize="sm">
                ...
                <VStack spacing={3} align="stretch">
                  ...
                  <Link as={RouterLink} to="/" _hover={{ textDecoration: 'none' }} w="full">
                    <Button
                      variant="ghost"
                      w="full"
                      minH="44px"
